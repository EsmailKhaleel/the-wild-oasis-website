...
function CabinCard({ cabin }) {
  ...
  return (
    <div className="overflow-hidden rounded-md border sm:border-none border-primary-800 bg-primary-950 flex flex-col sm:flex-row">
      <div className="relative w-full sm:w-[160px] lg:w-[200px] aspect-[4/3] sm:aspect-auto flex-shrink-0">
        <Image
          src={image}
          fill
          placeholder="blur"
        ...
        <div className="pt-5 pb-4 px-7 bg-primary-950">
          ...
          <p className="flex gap-3 justify-end items-baseline">
            {discount > 0 ? (
              ...
              <span className="text-lg md:text-2xl lg:text-3xl font-[350]">${regularPrice}</span>
            )}
